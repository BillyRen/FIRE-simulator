...
def run_sim_batch_backtest(
    ...
    return {
        ...
        "final_min": stats.final_min,
        "final_max": stats.final_max,
        "final_mean": stats.final_mean,
        "final_median": stats.final_median,
        "final_percentiles": {str(k): float(v) for k, v in stats.final_percentiles.items()},
