...
def _run_guardrail_and_build_result(
    ...
    sim_kwargs = dict(
        ...
        upper_adjustment_pct=req.upper_adjustment_pct,
        lower_adjustment_pct=req.lower_adjustment_pct,
    ...
    if cf_table_result is not None:
        ...
        upper_trigger_wd = apply_guardrail_adjustment(
            ...
            upper_adjustment_pct=req.upper_adjustment_pct, lower_adjustment_pct=req.lower_adjustment_pct,
