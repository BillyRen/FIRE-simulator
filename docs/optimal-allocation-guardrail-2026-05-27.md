...
|---|---|---|---|---|
| 10/50/40 | 19.00 | 0.977 | **3.29%** | $19,935 |
| 20/50/30 | 19.25 | 0.977 | **3.55%** | $21,752 |
| 20/40/40 | 20.00 | 0.976 | **3.33%** | $20,124 |
| 10/40/50 | 20.00 | 0.975 | **3.05%** | $18,030 |
| 00/40/60 | 20.05 | 0.975 | **2.71%** | $16,274 |
| 00/30/70 | 20.25 | 0.974 | **2.44%** | $14,704 |
| ... | | | | |
...
> P10_min_wd 计算修复（Codex review codex-commit-7878f08）：现在包括破产后填 0 的 wd，避免 path 在 horizon 中破产时 P10 只反映 pre-depletion 最小值。修复后所有 P10_wd 数值变小（$24k → $22k 区间），与 v1 cvar_10 语义一致。
...
|---|---|---|---|---|---|---|---|---|
| **30/60/10** | **14.65** | 27.9 | 9.3 | 6.8 | 0.976 | 3.83% | $22,965 | 1.1 |
| 20/60/20 | 14.93 | 20.8 | 9.7 | 14.3 | 0.977 | 3.69% | $22,771 | 1.0 |
| 30/50/20 | 15.10 | 22.8 | 9.6 | 12.9 | 0.976 | 3.72% | $22,465 | 1.1 |
| 40/50/10 | 15.83 | 30.6 | 9.7 | 7.2 | 0.974 | 3.83% | $22,523 | 1.1 |
| 20/70/10 | 16.37 | 27.2 | 12.0 | 9.8 | 0.975 | 3.78% | $22,746 | 1.1 |
| 20/50/30 | 18.67 | 19.2 | 14.3 | 22.4 | 0.977 | 3.55% | $21,752 | 1.0 |
| 40/40/20 | 18.70 | 28.2 | 13.2 | 14.6 | 0.974 | 3.69% | $21,589 | 1.1 |
| 40/60/00 | 19.43 | 37.0 | 16.2 | 5.1 | 0.973 | 3.89% | $22,362 | 1.2 |
| 30/70/00 | 19.43 | 35.0 | 17.1 | 6.2 | 0.974 | 3.87% | $22,382 | 1.1 |
| 10/70/20 | 19.50 | 23.2 | 16.7 | 18.6 | 0.976 | 3.62% | $22,027 | 1.0 |
...
|---|---|---|---|
| 1 | 30/60/10 | 30/60/10 | ✅ |
| 2 | 40/50/10 | 20/60/20 | ✅(序变) |
| 3 | 20/70/10 | 30/50/20 | ✅(序变) |
| 4 | 30/50/20 | 40/50/10 | ✅(序变) |
| 5 | 40/60/00 | 20/70/10 | ✅(序变) |
| 6 | 30/70/00 | 20/50/30 | — |
| 7 | 20/60/20 | 40/40/20 | ✅(序变) |
| 8 | 40/40/20 | 40/60/00 | ✅(序变) |
...
**30/60/10** — composite 排名第一；mean init_SWR 3.83%, mean P10_wd $22.9k, mean eff_FR 0.976, mean yrs<floor 1.1。
