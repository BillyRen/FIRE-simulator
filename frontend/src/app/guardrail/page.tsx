  ...
  const handleRunSingleBacktest = async () => {
    ...
    try {
      ...
      setSelectedPath({
        ...
        g_survived: n >= params.retirement_years && res.g_portfolio[res.g_portfolio.length - 1] >= 0,
        b_survived: n >= params.retirement_years && res.b_portfolio[res.b_portfolio.length - 1] >= 0,
